...
public class InsurancePolicyPurchaseSuccessResponseData {
    ...
    private InsurancePolicyPurchaseSuccessBalanceData balanceData;
    ...
    @JsonProperty("balanceData")
    public InsurancePolicyPurchaseSuccessBalanceData getBalanceData() {
        return balanceData;
    }

    @JsonProperty("balanceData")
    public void setBalanceData(InsurancePolicyPurchaseSuccessBalanceData balanceData) {
