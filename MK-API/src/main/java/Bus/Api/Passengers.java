...
public class Passengers extends BaseApi {

    public Passengers(PassengersRequestDto payload, String xMScope) {
        ...
        getSpecBuilder().setBasePath("api/bookings/passengers");
