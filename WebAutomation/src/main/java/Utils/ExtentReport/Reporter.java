...
public class Reporter {
    ...
    public static String EXTENTREPORTPATH = "src/Utils/ExtentReport/extent.html";
   ...
   /* @AfterMethod
    ...
    public void extentReportDisplay(String result, String details) throws IOException {
        switch (result) {
