...
public class CheckCrash {
    ...
    public static void Crashlytics() throws InterruptedException, IOException {
        ...
        int no, totalTabs,j;
        String m, test = "", testRed = "", freshTest = "";
...
//                }
                    ...
                    Thread.sleep(3000);
                    shortWait(driver, "//mat-checkbox[@class='mat-mdc-checkbox key-checkbox mat-accent'][1]");
                    driver.findElement(By.xpath("//mat-checkbox[@class='mat-mdc-checkbox key-checkbox mat-accent'][1]")).click();
                    try {
                    ...
                    Thread.sleep(2000);
                    driver.findElement(By.xpath("//div[@class='value-label'] [text()='Crashes']")).click();
