...
//        WebDriver driver = new RemoteWebDriver(new URL("https://" + username + ":" + accessKey + "@hub.browserstack.com/wd/hub"), capabilities);
        ...
        try {
            ...
            for (i = 0; i < responseTime.size(); i++) {
                System.out.println(responseTime.get(i) + "   " + changePercent.get(i) + "   " + apiName.get(i) + "   " + apiSuccess.get(i) + "   " + apiSample.get(i) + " " + changeSuccess1.get(i));
            }
            ...
            driver.findElement(By.xpath("//span[@class='header-text-wrapper fire-popover-trigger ng-star-inserted']")).click();
