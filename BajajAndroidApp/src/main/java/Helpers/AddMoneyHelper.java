...
//        }
        ...
        Element.waitForVisibility(driver, By.id("com.mobikwik_new.bajajfinserv:id/download_statement"));

        transactionHistoryPage.clickOnAddMoneyTransactionOfSixRupees();

        Element.waitForVisibility(driver, By.id("com.mobikwik_new.bajajfinserv:id/txt_txn_product"));

        transactionHistoryPage.clickOnRefundCta();

        Element.waitForVisibility(driver, By.id("com.mobikwik_new.bajajfinserv:id/vertical_button_1"));
