...
public class GoldHelper {
    ...
    public void buyGold(String securityPin, String amount) throws InterruptedException, IOException, JSONException {
        ...
        Element.waitForVisibility(driver, By.id("com.mobikwik_new.bajajfinserv:id/gold_purchased_or_sold"));


        mbReporter.verifyTrueWithLogging(Element.isElementPresent(driver, By.id("com.mobikwik_new.bajajfinserv:id/gold_purchased_or_sold")), "Invoice Id on History Page : " + goldPage.getInvoiceIdHistoryPage(), true, false);
    ...
    public void sellGold(String securityPin, String amount) throws InterruptedException, IOException, JSONException {
        ...
        if (Element.isElementPresent(driver, By.xpath("//android.widget.TextView[@text= 'Gold Balance :']"))) {
            ...
            if (Element.isElementPresent(driver, By.xpath("//android.widget.TextView[@text= 'Confirm Payment']"))) {
                ...
                mbReporter.verifyTrueWithLogging(!Element.isElementPresent(driver, By.id("com.mobikwik_new.bajajfinserv:id/txt_description_amount")), error, true, true);
