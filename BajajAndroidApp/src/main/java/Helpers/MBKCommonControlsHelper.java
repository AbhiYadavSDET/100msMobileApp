...
public class MBKCommonControlsHelper {
    ...
    public void handleNPS() throws InterruptedException {
        Thread.sleep(3000);
        if (Element.isElementPresent(driver, By.id("com.mobikwik_new.bajajfinserv:id/rating_seekbar"))) {
    ...
    public void handleRatingsPopUp() throws InterruptedException {
        Thread.sleep(3000);
        if (Element.isElementPresent(driver, By.id("com.mobikwik_new.bajajfinserv:id/content_root"))) {
