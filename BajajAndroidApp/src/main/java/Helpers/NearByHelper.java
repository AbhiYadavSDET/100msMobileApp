...
public class NearByHelper {
    ...
    public void nearbyStoreByAddress() throws InterruptedException, IOException, JSONException {
        ...
        List<AndroidElement> stores = Element.findElements(driver, By.id("com.mobikwik_new.bajajfinserv:id/tv_name"));
        ...
        mbReporter.verifyTrueWithLogging(Element.isElementPresent(driver, By.id("com.mobikwik_new.bajajfinserv:id/tx_tag")), "Total Stores count displayed on home page: " + totalStoreCount, true, false);
