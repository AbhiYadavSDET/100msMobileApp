...
public class TransactionHistoryPage {
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/btnVerfiySignUp")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/txt_txn_product")
    public AndroidElement invoice_page;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/refund_cta")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/vertical_button_1")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/refund_status_title")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/amount_text")
