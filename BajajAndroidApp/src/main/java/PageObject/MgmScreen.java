...
public class MgmScreen extends MobiKwikScreen {
    public MgmScreen(AndroidDriver driver) {
        super(driver);
    }

    public By wallet = By.xpath("//android.widget.TextView[@text = 'Wallet']");
    public By mgmPoints = By.id("com.mobikwik_new.bajajfinserv:id/reward_option_loylty");
    public By mgmAddNewCard = By.id("com.mobikwik_new.bajajfinserv:id/fab_add_card");
    public By mgmTitle = By.id("com.mobikwik_new.bajajfinserv:id/mkab_title");
    ...
    public By continueBtn = By.id("com.mobikwik_new.bajajfinserv:id/redeem_balance_button");
}
