...
public class BusPage {
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/txt_departure_city")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/txt_title")
    private AndroidElement select_departure_city;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/txt_destination_city")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/proceed_button")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/btnFirst")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/pay_btn")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/onward_operator_txt")
    private AndroidElement text_onward_operator;


    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/total_amount_paid")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/cancel_button")
    private AndroidElement cta_cancel_ticket;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/cancel_complete")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/suceess_msg")
    private AndroidElement refund_message;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/home_button")
