...
public class OlaPage {
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/gps_turn_txt")
    private AndroidElement text_gps_off;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/gps_turn_on_btn")
    private AndroidElement button_turn_on_gps;


    //Ola MAP Page

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/drop_loc_layout")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/category")
    private AndroidElement select_address;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/btn_ride_now")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/confirm_pay_btn")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/tx_cab_category")
    private AndroidElement cab_category;


    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/tx_driver_name")
    private AndroidElement driver_name;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/cancel_ride_btn")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/back_to_home_btn")
