...
public class RechargePage {
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/see_all_plans")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/actual_continue")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/recharge_button")
    private AndroidElement cta_continue2;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/content_root")
    public AndroidElement popup;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/title_text")
    public AndroidElement popup_error;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/body_text")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/view_bill_text")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/connection_detail_button_recharge")
    public AndroidElement button_dth_continue;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/txt_promo_result_desc")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/connection_detail_textView_name")
    public AndroidElement label_success_screen_operator;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/connection_detail_textView_company")
    public AndroidElement label_success_screen_number;

    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/fixed_amount_value")
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/pending_desc")
...
//cta_continue
    ...
    @AndroidFindBy(id = "com.mobikwik_new.bajajfinserv:id/redeem_layout")
