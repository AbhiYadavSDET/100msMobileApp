...
import Helpers.BajajPageHelper;
...
@Test(groups = {"busValidateInstaCredit", "bajajSanity"}, priority = 1)
    public void Test01_Validate_Insta_credit() throws IOException, JSONException, InterruptedException {
        LoginHelper loginHelper = new LoginHelper(getAndroidDriver());
//    loginHelper.quickLoginViaEmail(frontEndEntity.getUserName(), frontEndEntity.getPassword());
    loginHelper.quickLoginViaEmail("amityd321@gmail.com", "Test@1234");
...
@Test(groups = {"busValidateHomePageAds", "bajajSanity"}, priority = 2)
    public void Test01_Validate_Home_Page_Ads() throws IOException, JSONException, InterruptedException {
        LoginHelper loginHelper = new LoginHelper(getAndroidDriver());
//        loginHelper.quickLoginViaEmail(frontEndEntity.getUserName(), frontEndEntity.getPassword());
        loginHelper.quickLoginViaEmail("amityd321@gmail.com", "Test@1234");
