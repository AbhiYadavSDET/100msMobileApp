...
Mobile.setText(    findTestObject('Object Repository/PayRentToUPI/4. Enter Name, Number, UPI ID or Scan QR')     , "7795709569@paytm", 0);
Mobile.tap(  findTestObject('Object Repository/PayRentToUPI/5. 9910757211ikwik')  , 0)
...
CustomKeywords.'template.appFunctions.checkPaymentBottomSheet'(10)
//closing the app
