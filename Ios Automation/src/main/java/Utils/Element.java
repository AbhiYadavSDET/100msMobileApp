...
public class Element {
     ...
     */
    public static List<IOSElement> findElements(IOSDriver<IOSElement> driver, By locator) {
        try {
     ...
     *                              activity.
     */
    public static Boolean isElementPresent(IOSDriver<IOSElement> iosDriver, By targetElement) throws InterruptedException {
        Thread.sleep(2000);
