...
//        rechargePage.selectNumberPrepaid();
    ...
    public void changeOperator(String exptitleSelectOperator,String exptitleSelectCircle) throws InterruptedException, IOException {
        ...
        // Click On Chane button
        rechargePage.clickOnChnage();

        // Verification on the Success Screen
        String titleSelectOperator = rechargePage.gettextOnSelectOperator();
        ;
        Log.info("Select Operator : " + titleSelectOperator);

        // Add the assertions
        mbReporter.verifyEquals(titleSelectOperator, exptitleSelectOperator, "txt Select Operator", false, false);

        // Select one operator
        rechargePage.clickOnBsnl();

        String titleSelectCircle = rechargePage.gettextOnSelectCircle();

        Log.info("Select Circle : " + titleSelectCircle);

        // Add the assertions
        mbReporter.verifyEquals(titleSelectCircle, exptitleSelectCircle, "txt Select Circle", false, false);

        // Select one operator
        rechargePage.clickOnFirstDropDown();
