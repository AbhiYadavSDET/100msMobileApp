...
public class GoldTest extends TestBase {
    ...
    @Test(groups = {"sanity", "goldBuy"}, priority = 0, description = "Verify Gold Buy")
    ...
    @Test(groups = {"sanity", "goldSell"}, priority = 1, description = "Verify Gold Sell")
