...
public class MgmScreen extends MobiKwikScreen {
    ...
    public By mgmPoints = By.id("reward_option_loylty");
    public By mgmAddNewCard = By.id("fab_add_card");
    public By mgmTitle = By.id("mkab_title");
    ...
    public By continueBtn = By.id("redeem_balance_button");
}
